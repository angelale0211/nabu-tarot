...
SCRIPTS = ['config.js', 'logo-data.js', 'services.js', 'strings.js', 'art.js', 'tarot-en.js', 'tarot-vi.js', 'kb-questions.js',
           ...
           'core.js', 'backend.js', 'share.js', 'ai.js', 'home.js', 'pick.js', 'learn.js', 'lessons.js', 'fortune.js', 'playing.js', 'guide-visuals.js', 'codes.js', 'angel.js', 'love.js', 'quiz.js', 'quiz-tarot.js', 'quiz-len.js', 'quiz-play.js', 'looks.js', 'luck.js', 'pet.js', 'book.js', 'me.js', 'contact.js', 'privacy.js', 'install.js', 'report.js', 'play.js', 'wedding.js', 'alerts.js', 'admin.js', 'main.js']
