...
SCRIPTS = ['config.js', 'logo-data.js', 'services.js', 'strings.js', 'art.js', 'tarot-en.js', 'tarot-vi.js', 'kb-thuanh.js',
           ...
           'core.js', 'backend.js', 'ai.js', 'home.js', 'pick.js', 'learn.js', 'lessons.js', 'fortune.js', 'guide-visuals.js', 'book.js', 'me.js', 'contact.js', 'privacy.js', 'report.js', 'admin.js', 'main.js']
