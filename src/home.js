...
const TOUR = [
  ...
  { ic: '🎲', vi: ['Hoạt động', 'Nuôi bạn nhỏ may mắn, buộc sợi tơ hồng, rung cây thông điệp, tung đồng xu, viết nhật ký. Khi Nabu đăng thì có thêm tụ bài, bình chọn và điều ước.'], en: ['Activities', 'Keep a lucky companion, tie the red thread, shake the message tree, flip the coin, write the diary. When Nabu posts there are piles to pick, polls to vote in and wishes to send.'] },
  ...
  { ic: '\uD83E\uDDE7', vi: ['Sợi tơ hồng', 'Bạn đặt cho mình một cái tên rồi gửi cho người ấy. Khi người ấy đồng ý, Nabu bắt đầu đếm số ngày hai bạn bên nhau. Từ đó hai bạn có thể ngỏ lời, đính ước, tặng quà cho nhau và tổ chức lễ cưới ngay trong ứng dụng.'], en: ['The red thread', 'Tie a thread with somebody: choose a name, give it to them, and once they agree the app starts counting your days. After that you can ask, get engaged, send gifts and hold a wedding.'] },
  ...
  { ic: '\uD83D\uDD14', vi: ['Làm mới & thông báo', 'Ở bất kỳ trang nào, bạn kéo màn hình xuống từ trên cùng là app tự làm mới và cập nhật bản mới nhất. Chuông ở góc trên bên phải giữ lại những gì đã xảy ra khi bạn không mở app.'], en: ['Refresh & notifications', 'On any screen, pull down from the top and the app refreshes itself to the newest version. The bell in the top corner keeps whatever happened while you were away.'] },
