...
const TOUR = [
  ...
  { ic: '\uD83E\uDDE7', vi: ['Sợi tơ hồng', 'Buộc sợi tơ hồng với một người: bạn đặt tên riêng, đưa cho người ấy, và người ấy đồng ý là app bắt đầu đếm ngày cho hai bạn. Sau đó có thể ngỏ lời, đính ước, tặng quà và tổ chức lễ cưới.'], en: ['The red thread', 'Tie a thread with somebody: choose a name, give it to them, and once they agree the app starts counting your days. After that you can ask, get engaged, send gifts and hold a wedding.'] },
