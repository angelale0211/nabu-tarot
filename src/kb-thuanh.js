/* ==================== question-specific readings ====================
   Extracted from Thu Anh's per-card lectures on the channel Tự Học Tarot
   cùng Thu Anh (playlists HƯỚNG DẪN TAROT CHI TIẾT — Ẩn Chính and Ẩn Phụ).
...
'major-0': [
    ...
    'major-2': [
      ...
      ['other', 'Rút một mình lá này thì đọc thế nào?',
       'Đây là lá khó diễn giải khi đứng một mình. Cá nhân Thu Anh khi gặp lá này trong trải bài thường phải bốc thêm lá nữa mới đọc được.']
    ],
...
'major-0': [
    ...
    'major-2': [
      ...
      ['other', 'How do I read this card on its own?',
       'It is a hard card to interpret alone. Thu Anh\'s own practice when it turns up in a spread is to draw an additional card before reading it.']
    ],
...
Object.assign(ASK.vi, {
  ...
  'major-8': [
    ...
    ['other', 'Lá này ra ở vị trí lời khuyên thì đọc thế nào?',
     'Thu Anh không đọc bài ngược, và với lá này cá nhân cô chỉ thấy nghĩa tích cực. Khi nó ra ở vị trí lời khuyên, cô đọc là: bạn đang thiếu sức mạnh, thiếu sự kiểm soát bản thân, thiếu bình tĩnh — đang để phần con thú bên trong kiểm soát mình và làm mất đi lý trí tỉnh táo. Bài khuyên bạn vững vàng hơn, mạnh mẽ hơn, và kiểm soát cơn giận.']
  ],
  ...
  'major-9': [
    ...
    ['timing', 'Bao giờ tôi mới tìm được câu trả lời?',
     'Không dễ tìm, và nó mất thời gian. Với Thu Anh là một năm; với người khác có thể còn lâu hơn.']
  ]
});
...
Object.assign(ASK.en, {
  ...
  'major-9': [
    ...
    ['timing', 'When will I find the answer?',
     'It is not easy to find, and it takes time. For Thu Anh it took a year; for someone else it might take longer.']
  ]
});
...
Object.assign(ASK.vi, {
  ...
  'major-11': [
    ...
    ['career', 'Thời gian tới công việc có gì cần lưu ý?',
     'Có thể bạn gặp trục trặc về giấy tờ, thủ tục hành chính trong công việc. Ví dụ sếp có quyết định tăng lương nhưng vì thiếu giấy tờ nên chưa tăng được, chưa thăng chức được. Thu Anh từng chứng kiến một người bạn mới ra trường được phòng muốn tăng lương và thăng chức, nhưng chưa có bằng đại học nên bên nhân sự không duyệt.'],
...
Object.assign(ASK.en, {
  'major-10': [
    ...
    ['other', 'So can fate be changed?',
     'Thu Anh\'s view: everyone is born into a set range of destiny — say from 30 to 80. Live decently and develop your full potential and you reach the ceiling of 80, but never beyond it. Live badly and you sink to 30, but no lower. Not everyone who tries becomes Einstein — but only by trying your hardest do you get the most out of what you were given.']
  ],
...
Object.assign(ASK.vi, {
  ...
  'major-17': [
    ...
    ['other', 'Ra lá này thì chắc chắn có hi vọng chứ?',
     'Không hẳn. Từ khóa tích cực là hi vọng, tương lai tươi sáng, sau cơn mưa trời lại sáng, cơ hội mới. Nhưng từ khóa tiêu cực là bị lý tưởng hóa, kỳ vọng đặt quá cao. Thu Anh thường rút thêm và hỏi "thế bạn có hành động không" — nếu ra những lá xấu thì bạn sẽ không hành động, chỉ biết ngồi và hi vọng; đến khi cơ hội đến mà không biết cách chớp lấy thì cũng bằng không.']
  ]
});
...
Object.assign(ASK.en, {
  ...
  'major-17': [
    ...
    ['other', 'So this card guarantees hope?',
     'Not quite. Its positive keywords are hope, a bright future, sunshine after rain, a fresh opportunity. But its negative keyword is being idealised, expectations pitched far too high. Thu Anh usually draws more and asks "and will you act?" — if bad cards follow, you will not act, only sit and hope; and an opportunity you do not know how to seize amounts to nothing.']
  ]
});
...
Object.assign(ASK.vi, {
  ...
  'major-21': [
    ...
    ['love', 'Hai người hợp nhau là hợp ở điểm gì?',
     'Tính cách và cách tiếp cận vấn đề khác nhau thì bù trừ được cho nhau, giúp nhau nhìn sự việc từ nhiều góc độ. Nhưng giá trị cốt lõi thì nên giống nhau. Nếu đích đến của hai người khác nhau — một người hướng đến sự ổn định lâu dài, có gia đình con cái, còn một người chỉ thích rong ruổi và xác định độc thân cả đời, yêu chỉ để vui — thì dù tính cách giống hệt nhau, sở thích giống hệt nhau, hai bạn vẫn phải chia tay. Ngược lại, nếu tính cách hai người như nước với lửa nhưng cả hai cùng hướng đến một gia đình đầm ấm, thì họ hòa hợp và bù trừ được cho nhau — với Thu Anh, đó mới là một mối quan hệ lý tưởng. Còn giá trị cốt lõi vừa giống nhau mà tính cách cũng giống nhau thì hai người làm bạn hợp hơn, vì không bù trừ được nhiều cho nhau.']
  ]
});
...
Object.assign(ASK.vi, {
  ...
  'cups-1': [
    ...
    ['love', 'Cãi nhau, có nên chia tay không?',
     'Chia tay gì mà chia tay, tình cảm dạt dào thế này cơ mà. Thậm chí có thể hỏi ngược lại người hỏi: tình cảm nhiều thế này thì chắc hai người chỉ cãi nhau bé thôi chứ gì. Chỉ cần ngồi với nhau nói chuyện vài bữa là lại yêu nhau. Quan điểm của Thu Anh: chỉ cần còn tình cảm — linh hồn của bạn biết là bạn vẫn còn muốn ở cạnh linh hồn người đó — thì hai bạn sẽ tìm được cách giải quyết và hòa hợp. Ngược lại, ở cạnh nhau, môn đăng hộ đối, hoàn cảnh gia đình đều thuận lợi mà không có tình cảm với nhau thì có khuyên mấy cũng không nên ở cùng nhau nữa. Còn đã có tình cảm thì những yếu tố bên ngoài — gia cảnh, văn hóa, tôn giáo — đều có thể hòa hợp được.'],
...
Object.assign(ASK.vi, {
  ...
  'pentacles-3': [
    ['love', 'Miêu tả tính cách một người?',
     'Tương đối nghiêm túc. Nếu Ba Cốc là người thích ở bên cạnh người khác để tụ tập ăn chơi, thì Ba Tiền cũng thích ở cạnh người khác nhưng là để cùng nhau làm một điều gì đó có ích. Trong công việc, đây là người thích làm việc nhóm, thích môi trường công ty công sở, chứ không phải kiểu thích làm một mình. Nó khiến Thu Anh liên tưởng đến năng lượng Bảo Bình: muốn tập hợp nhiều người lại để cùng làm điều gì có ích, chứ không phải tập hợp để chơi.'],
    ['love', 'Tình cảm người ấy dành cho tôi thế nào?',
...
Object.assign(ASK.en, {
  ...
  'pentacles-3': [
    ['love', 'Describe this person\'s character',
     'Fairly serious. Where the Three of Cups likes being with others to gather and enjoy themselves, the Three of Pentacles likes being with others to do something useful together. At work this is someone who likes working in a group, likes a company or office setting, rather than someone who prefers working alone. It puts Thu Anh in mind of Aquarius energy: wanting to bring people together to do something worthwhile, not merely to socialise.'],
    ['love', 'What are their feelings toward me?',
...
Object.assign(ASK.vi, {
  ...
  'swords-4': [
    ...
    ['career', 'Người phỏng vấn có nhận ra điều đó không?',
     'Có. Ít nhiều họ đọc vị được bạn qua buổi phỏng vấn. Phỏng vấn kiến thức là một chuyện, nhưng họ còn xem xét thái độ và niềm yêu thích, sự đam mê của bạn với công việc. Thu Anh có một người bạn đi phỏng vấn vị trí giao dịch viên ngân hàng, và người phỏng vấn nói thẳng: "Chị cảm thấy em thật sự không thích làm công việc này, em chỉ đi xin cho có thôi."'],
    ['career', 'Thời gian tới công việc có gì thay đổi không?',
  ...
  'pentacles-4': [
    ...
    ['other', 'Vì sao nên buông bỏ?',
     'Bài học của Bốn Tiền là buông bỏ sự tham lam và buông bỏ kiểm soát. Nếu bạn cứ giữ khư khư món đồ chơi mà bạn không dùng đến, thì bạn sẽ không bao giờ biết là có những món đồ chơi tốt hơn đang chờ mình. Thu Anh kể rằng chính cô từng là người luôn muốn mọi thứ theo ý mình, và sau nhiều lần — trong học tập, công việc, tình cảm — cô nhận ra mọi thứ luôn đi chệch hướng. Nhưng nhìn lại một quãng dài thì mọi thứ đều có lý do: lý do cô thất bại ở một mối quan hệ hay một cơ hội là vì có một cánh cửa khác tốt hơn đang chờ phía trước. Ở thời điểm đó thì đau khổ, sụp đổ, thất vọng; nhưng khi cánh cửa mới đến thì nhìn lại mới thấy: nếu không thất bại ở cái cũ thì đã chẳng bao giờ biết là có cơ hội mới này.']
  ]
});
...
Object.assign(ASK.en, {
  ...
  'swords-4': [
    ...
    ['career', 'Would an interviewer notice that?',
     'Yes. They read you at least in part across an interview. Testing your knowledge is one thing, but they are also weighing your attitude and your genuine appetite for the work. Thu Anh had a friend interviewing for a bank teller role who was told outright: "I get the feeling you do not really want this job, that you are only applying for the sake of it."'],
    ['career', 'Any change at work coming?',
  ...
  'pentacles-4': [
    ...
    ['other', 'Why should I let go?',
     'The lesson of the Four of Pentacles is to let go of greed and let go of control. Keep clutching a toy you never even use and you will never learn there are better ones waiting for you. Thu Anh says she was once exactly the person who wanted everything her own way, and after several rounds of it — in study, in work, in love — she found that everything always went off course. But looking back across a long stretch, everything had its reason: the reason she failed at a relationship or an opportunity was that a better door was waiting further on. At the time it was collapse and disappointment and every worst feeling; and when the new door came she looked back and saw that without the failure she would never have known the new opportunity was there at all.']
  ]
});
...
Object.assign(ASK.en, {
  ...
  'swords-5': [
    ...
    ['other', 'What is the karma of speech?',
     'Wounding someone with words, humiliating them, is exactly that karma. Do not imagine it does not matter — it accumulates, and it is bad karma. When she is humiliated, Thu Anh takes it that perhaps in a past life she humiliated them and this life they are repaying it; or that she once spoke harshly to others and now someone else returns it to her. And if you are about to say something cutting: however much you dislike them, never leave another person carrying a wound — every negative feeling you cause in someone else is karma.']
  ],
  'cups-5': [
...
Object.assign(ASK.vi, {
  'wands-6': [
    ...
    ['other', 'Cùng một từ khóa thì lá nào mạnh hơn?',
     'Quy tắc của Thu Anh: nếu hai lá cùng từ khóa mà một là Ẩn Phụ, một là Ẩn Chính, thì lá Ẩn Phụ mang cường độ và tần suất nhẹ hơn. Và trong Ẩn Phụ thì số càng cao năng lượng càng lớn: một lá số 3 nhẹ hơn lá số 10, và lá số 10 vẫn nhẹ hơn một lá Ẩn Chính.']
  ],
  'swords-6': [
    ['love', 'Miêu tả tính cách một người?',
...
Object.assign(ASK.en, {
  'wands-6': [
    ...
    ['other', 'Which card is stronger when the keyword is the same?',
     'Thu Anh\'s rule: where two cards share a keyword and one is a Minor and one a Major, the Minor carries lower intensity and frequency. And inside the Minors, the higher the number the greater the energy: a three is lighter than a ten, and a ten is still lighter than a Major.']
  ],
  'swords-6': [
    ['love', 'Describe this person\'s character',
...
Object.assign(ASK.vi, {
  ...
  'swords-7': [
    ...
    ['other', 'Thao túng cảm xúc là gì?',
     'Bảy Kiếm đôi khi khiến Thu Anh nghĩ đến từ khóa thao túng cảm xúc. Việc người A thao túng người B xảy ra thường xuyên như cơm bữa trong cuộc sống hằng ngày; nếu không để ý và quan sát thì bạn bị thao túng, hoặc bạn thao túng người khác, một cách vô thức mà không nhận ra. Những người có khả năng thao túng người khác thường là người thông minh, có trí tuệ cảm xúc cao. Chuyện này xảy ra nhiều nhất trong tình cảm và với cấp trên. Người thao túng giỏi thường rất duyên dáng, được lòng nhiều người, biết cách chèo lái câu chuyện, biết nói gì và tỏ thái độ thế nào để người khác nghe theo, biết dùng từ nào vào thời điểm nào để đánh vào tâm lý người nghe. Bạn cứ quan sát sẽ thấy có những người như thế, và có những người nghĩ gì nói đấy.']
  ],
  'cups-7': [
...
Object.assign(ASK.en, {
  ...
  'swords-7': [
    ...
    ['love', 'What are their feelings toward me?',
     'Condolences. Thu Anh met exactly this case: a client asked what he thought of her, since the two were getting to know each other, and the Seven of Swords came up — what surfaced was that he already had a girlfriend and the client was only the third person. She later confirmed it: he had said he had just broken up, when in fact the two were still in a relationship of sorts, not properly ended. Fortunately she had not yet accepted him, and having seen the reading she pressed him and he admitted it. Note this: the furtiveness need not be that HE has a third person — it may be that YOU are the third person.'],
    ['love', 'We argue a lot — should we break up?',
...
Object.assign(ASK.vi, {
  ...
  'pentacles-8': [
    ...
    ['love', 'Miêu tả tính cách một người?',
     'Một người tỉ mỉ, có thể theo chủ nghĩa hoàn hảo, rất chăm chỉ và cầu toàn, nhưng giỏi khi làm một mình hơn là làm với nhiều người. Thu Anh nghĩ ngay đến cung Xử Nữ. Nhược điểm của người mang năng lượng này: đôi khi họ không nhìn được bức tranh toàn cảnh — họ bới móc lỗi, chỉ nhìn được phần thiếu và phần sai sót của bức tranh mà không có khả năng tận hưởng toàn bộ bức tranh.'],
    ['love', 'Tình cảm người ấy dành cho tôi thế nào?',
...
Object.assign(ASK.en, {
  ...
  'pentacles-8': [
    ...
    ['love', 'Describe this person\'s character',
     'Someone meticulous, possibly a perfectionist, very diligent and exacting, and better working alone than among many. Thu Anh thinks immediately of Virgo. The weakness of this energy: sometimes they cannot see the whole picture — they pick at faults, seeing only the missing and the flawed parts and never able to enjoy the whole of it.'],
    ['love', 'What are their feelings toward me?',
...
Object.assign(ASK.en, {
  ...
  'swords-9': [
    ...
    ['love', 'Should I love someone carrying this card?',
     'Weigh it carefully. This person\'s problem is not something that can be solved from one side, and not something anyone can arrive and heal for them. If you believe you can heal them, you are mistaken — the problem is theirs to solve. To an ordinary client Thu Anh would put it that way; if it were her own sister or her own friend, she would say it outright: do not love this person.'],
    ['love', 'We argue a lot — should we break up?',
...
Object.assign(ASK.vi, {
  ...
  'swords-10': [
    ...
    ['other', 'Nói chuyện với người mang lá này thì thế nào?',
     'Bạn sẽ thấy mệt, kể cả khi bạn không phải người nhạy cảm về năng lượng. Thu Anh hay gọi những người này là quỷ hút năng lượng: chúng ta có ma cà rồng hút máu thì cũng có ma cà rồng hút năng lượng. Họ luôn than thở và cằn nhằn hết chuyện này đến chuyện khác mà không chịu tự nhìn nhận vấn đề và tự đứng lên giải quyết; lần thứ hai gặp họ thì họ lại tiếp tục than thở về đúng những vấn đề ấy. Họ không ngồi lắng nghe bạn — họ chỉ muốn trút lên đầu bạn những điều tiêu cực trong đời họ.'],
    ['love', 'Tình cảm người ấy dành cho tôi thế nào?',
    ...
    ['other', 'Vì sao Thu Anh không nhận xem cho những người này?',
  ...
  'pentacles-10': [
    ...
    ['other', 'Vì sao nó khác Mười Cốc?',
     'Theo cảm nhận và kinh nghiệm riêng của Thu Anh: Mười Tiền không nhẹ nhõm như Mười Cốc. Mười Cốc là sung túc đầy đủ; còn Mười Tiền thì hơi gò bó, hơi cứng — như kiểu bạn sinh ra trong một gia đình đầy đủ ông bà bố mẹ, một gia đình khá truyền thống, gia giáo, tương đối dư giả. Sinh ra trong gia đình như thế thì đôi khi bạn sẽ thấy áp lực: gia đình muốn bạn làm cái này, muốn bạn làm cái kia. Bạn đang ở trong một tình huống rất nhiều tiền mà lại cảm thấy bị gò bó, và bạn không thể cứ thế mà bỏ cơ hội vật chất này để đi theo tiếng gọi con tim được.'],
    ['love', 'Miêu tả tính cách một người?',
...
Object.assign(ASK.en, {
  ...
  'swords-10': [
    ...
    ['other', 'Why does Thu Anh no longer read for them?',
...
Object.assign(ASK.vi, {
  'wands-c0': [
    ...
    ['love', 'Miêu tả tính cách một người?',
     'Khá nhiệt huyết, đam mê, là con người của hành động — ra ngoài và làm. Nhìn hình ảnh: anh chàng cầm cây gậy và nhìn xa xăm, như thể lúc nào cũng muốn bắt đầu một hành trình mới. Với Thu Anh thì lá này luôn mang năng lượng tích cực nhiều hơn. Người mang năng lượng Tiểu Đồng Gậy có thể còn khờ dại, còn thiếu kinh nghiệm, hơi giống lá Gã Khờ — nhưng họ không hề thiển cận. Không phải kiểu thiếu kinh nghiệm mà ai giảng cho thì gạt đi "tao biết tao giỏi, tao không muốn nghe mày".'],
  ...
  'cups-c0': [
    ...
    ['love', 'Cãi nhau, nên làm gì?',
     'Có thể một trong hai hoặc cả hai mang năng lượng Tiểu Đồng Cốc khiến người kia cứ cảm thấy bất an cho mối quan hệ. Và thứ hai: cả hai đều khá trẻ và còn non. Dù tình cảm dành cho nhau là có thật, nhưng vì trẻ nên có nhiều thứ đáng lẽ giải quyết rất dễ mà hai người lại chọn cách xử lý vụng về, thành ra chẳng đâu vào đâu. Thu Anh cảm nhận điều này từ chính mình và những người xung quanh: khi còn trẻ, xử lý các tình huống trong quan hệ — kể cả bạn bè lẫn người yêu — ta khờ khạo lắm; đến khi lớn rồi nhìn lại, hoặc nghe những câu chuyện như thế, thì thấy ngay là chuyện này giải quyết rất dễ, chẳng có gì phải lăn tăn.'],
...
Object.assign(ASK.en, {
  'wands-c0': [
    ...
    ['love', 'Describe this person\'s character',
     'Quite enthusiastic and passionate, a person of action who goes out and does things. Look at the image: he holds his staff and gazes into the distance, as though he always wants to be starting a new journey. For Thu Anh this card always carries more positive energy than not. The Page of Wands may still be naive and inexperienced, a little like the Fool — but they are not narrow-minded. Not the type who lacks experience and, when someone explains, waves it away with "I know I am good, I do not want to hear you."'],
  ...
  'cups-c0': [
    ...
    ['love', 'Are they better as a friend or a partner?',
     'By Thu Anh\'s own experience, possibly better as a friend. Because in a partner we want someone who loves us; and this person is like a child skipping about — sees A and loves A, runs to B and loves B. Not infidelity exactly: it is that they are interested in a great many things. Not that they love you and also love another woman, but that they love you and at the same time love their games and their other interests. Quite unlike the Knight of Cups — the Knight is the one who really is the unfaithful type, a little of the philanderer about him.'],
    ['love', 'What are their feelings toward me?',
    ...
    ['love', 'We are arguing — what should we do?',
     'One of you, or both, may be carrying Page of Cups energy that leaves the other feeling permanently unsettled. And second: you are both quite young and green. The feeling between you may be entirely real, and because you are young there are things that would be very easy to resolve and that the two of you handle clumsily instead, so nothing comes right. Thu Anh sees it in herself and in those around her: young, handling situations in any relationship — friends as much as lovers — we are clumsy; and later, grown, looking back or hearing such a story, you see at once how simply it could be solved.'],
...
Object.assign(ASK.vi, {
  ...
  'pentacles-c1': [
    ...
    ['love', 'Anh ta / cô ta muốn gì ở tôi và ở mối quan hệ này?',
     'Với Kỵ Sĩ Xu thì người ta muốn kết hôn, và họ là người khá chung thủy trong tình cảm. Tuy nhiên họ cứng đầu, họ nông cạn, họ nhạt nhẽo. Còn bạn có thích người như thế hay không thì nằm ở bạn. Thu Anh chỉ phân tích người này cho bạn chứ không khuyên bạn nên hay không nên yêu người này, vì lúc đấy sẽ bị ảnh hưởng bởi điểm nhìn cá nhân, chủ quan của reader: nếu reader thích kiểu người này thì sẽ bảo bạn yêu đi, còn nếu không thích thì sẽ bảo "chán lắm, yêu làm gì".'],
    ['love', 'Vì sao hai đứa tôi hay cãi nhau?',
...
Object.assign(ASK.en, {
  ...
  'pentacles-c1': [
    ...
    ['love', 'What does he or she want from me and from this relationship?',
     'With the Knight of Pentacles the person wants marriage, and they are quite faithful in a relationship. However, they are stubborn, they are shallow, they are dull. Whether you like that kind of person is up to you. Thu Anh only analyses the person for you and does not advise you whether or not to love them, because at that point the reader’s personal, subjective view creeps in: if the reader likes this type they will tell you to go for it, and if they do not, they will say "how boring, why bother."'],
    ['love', 'Why do the two of us argue so much?',
...
Object.assign(ASK.vi, {
  'wands-c2': [
    ...
    ['love', 'Anh ta / cô ta có tình cảm với tôi không?',
     'Có. Và đây là một tình cảm khá thành thật, không vụ lợi. Người này cũng khá thẳng thắn với cảm xúc của họ: họ yêu bạn thì họ nói là yêu, nói A là A, nói B là B. Thế nên nếu ra lá này cho tình cảm người ta dành cho bạn thì Thu Anh nói luôn: bạn gặp được người này là may mắn rồi.'],
  ...
  'cups-c2': [
    ...
    ['career', 'Tôi đang làm văn phòng bình thường, thời gian tới có gì thay đổi không?',
     'Có thể tại thời điểm hiện tại bạn đã tận hưởng và đã thích công việc của bạn rồi, thì thời gian tiếp theo bạn vẫn tiếp tục thích công việc này, không có gì đáng để bàn cãi — hoặc thời gian tiếp theo bạn còn yêu công việc hơn nữa. Hoặc, trên thực tế Thu Anh đã gặp một trường hợp như thế này: ra lá này cho câu hỏi dự đoán công việc thì thời gian tới bạn ấy sẽ có cấp dưới, sẽ có nhân viên mới, và bạn ấy đóng vai trò người hướng dẫn, chỉ bảo tận tình cho bạn nhân viên mới đó.'],
  ...
  'pentacles-c2': [
    ...
    ['other', 'Lá Xu có ý nghĩa tiêu cực không?',
     'Xu không xấu, không có ý nghĩa tiêu cực — trừ khi bạn đọc bài ngược, hoặc nó đi kèm với những lá tiêu cực khác. Còn nó đứng một mình thì ít khi đọc theo hướng tiêu cực; cá nhân Thu Anh thì chưa thấy bao giờ.'],
    ['love', 'Vì sao hai đứa tôi hay cãi nhau?',
...
Object.assign(ASK.en, {
  ...
  'pentacles-c2': [
    ...
    ['other', 'Does the Pentacles suit carry a negative meaning?',
     'Pentacles is not bad and has no negative meaning — unless you read reversals, or it comes alongside other negative cards. Standing alone it is rarely read negatively; personally Thu Anh has never seen it read that way.'],
    ['love', 'Why do the two of us argue so much?',
...
Object.assign(ASK.en, {
  ...
  'pentacles-c3': [
    ...
    ['money', 'Will I find work in the coming period?',
     'Honestly, when this card comes up for work you can be content. Any Pentacle at all — King, Queen, Ten, Nine — on a question of work, finance or study is satisfying (for study, Thu Anh does prefer Swords a little more). You will find work, and work with a lot of money in it. In this job you may even sit in a leadership position with title and authority; financially it is fine.'],
...
/* keywords batch 1 - all 22 Majors.
   Thu Anh teaches every card as a positive keyword set and a negative one, and
...
Object.assign(KW.vi, {
  ...
  'cups-1': { pos: ['một khởi đầu mới về mặt tình cảm, một cảm xúc mới','người tràn đầy cảm xúc tích cực','yêu bản thân, yêu quý những người xung quanh và sẵn sàng giúp đỡ mọi người','luôn nhìn đời bằng lăng kính tích cực','ra cho câu hỏi tình cảm thì quá viên mãn'],
              neg: ['thường không có nghĩa tiêu cực — Thu Anh chưa gặp nghĩa tiêu cực bao giờ'] },
...
Object.assign(KW.en, {
  ...
  'cups-1': { pos: ['a new beginning in feeling; a new emotion','a person overflowing with positive feeling','loves themselves, loves the people around them, ready to help anyone','always looks at life through a positive lens','on a love question, as complete as it gets'],
              neg: ['usually no negative meaning — Thu Anh has never met one'] },
  ...
  'cups-2': { pos: ['partnership rather than love','a joining, a connection between two sides: business, trade, friendship, romance','finding a kindred spirit, someone who fits you','the energy of Libra: good at balance, good at negotiating and persuading, good at selling'],
              neg: ['usually read positively — Thu Anh has not found a negative meaning for this card'] },
