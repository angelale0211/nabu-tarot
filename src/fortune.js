...
const FT_CARDS = { ic: '🂡', vi: ['Bói bài Tây', '52 lá · nghĩa truyền thống & đối chiếu Tarot'], en: ['Playing cards', '52 cards · traditional meanings & Tarot comparison'], de: ['Spielkarten deuten', '52 Karten · traditionelle Deutung & Tarot-Vergleich'] };
const FT = {
  numbers: { ic: '🔢', vi: ['Thần số học', 'Số của bạn, từ ngày sinh và tên'], en: ['Numerology', 'Your numbers, from birth date and name'], de: ['Numerologie', 'Deine Zahlen aus Geburtsdatum und Name'] },
  palm: { ic: '🖐️', vi: ['Xem chỉ tay', 'Bản đồ bàn tay, chạm từng đường'], en: ['Palm reading', 'A map of the hand, tap each line'], de: ['Handlesendeutung', 'Handkarte — tipp auf jede Linie'] },
  tea: { ic: '🍵', vi: ['Bài trà', 'Bản đồ tách trà và các hình'], en: ['Tealeaf fortune telling', 'Cup map and the shapes'], de: ['Teeblätter lesen', 'Tassenkarte und typische Formen'] },
  animals: { ic: '🐉', vi: ['12 con giáp', 'Vòng con giáp, tam hợp, tứ hành xung'], en: ['12 animals', 'The wheel, trios and clashes'], de: ['12 Tierkreis-Tiere', 'Tierkreisrad, harmonische Gruppen und Spannungen'] }
};
...
const ANIMAL_EMOJI = ['🐀', '🐂', '🐅', '🐈', '🐉', '🐍', '🐎', '🐐', '🐒', '🐓', '🐕', '🐖'];
const ANIMAL_INFO = {
  vi: [['nhanh trí', 'khéo léo', 'tiết kiệm', 'Chuột nhanh, khôn và biết xoay xở. Hợp việc cần đầu óc và quan hệ.'], ['bền bỉ', 'thật thà', 'chậm mà chắc', 'Trâu chăm, chịu khó và giữ lời. Hợp việc cần kiên nhẫn.'], ['can đảm', 'nhiệt', 'thích dẫn đầu', 'Hổ mạnh mẽ, dám làm, hay bốc đồng. Hợp việc cần quyết đoán.'], ['nhẹ nhàng', 'khéo', 'cẩn trọng', 'Mèo tinh tế, hoà nhã, biết giữ mình. Hợp việc cần khéo léo.'], ['tự tin', 'may mắn', 'tự tôn', 'Rồng nổi bật, nhiều năng lượng và tham vọng. Hợp việc lớn.'], ['sâu sắc', 'bí ẩn', 'trực giác', 'Rắn khôn ngoan, kín đáo, suy nghĩ kỹ. Hợp việc cần chiều sâu.'], ['tự do', 'nhanh', 'nhiệt tình', 'Ngựa yêu tự do, hoạt bát, thích đi. Hợp việc di chuyển, giao tiếp.'], ['hiền', 'sáng tạo', 'nhạy cảm', 'Dê dịu dàng, nghệ sĩ, cần được yên. Hợp việc sáng tạo.'], ['thông minh', 'vui', 'tinh nghịch', 'Khỉ lanh lợi, sáng ý, thích đùa. Hợp việc cần ứng biến.'], ['chăm', 'thẳng', 'tỉ mỉ', 'Gà siêng năng, rõ ràng, hay góp ý. Hợp việc cần chính xác.'], ['trung thành', 'công bằng', 'cẩn trọng', 'Chó tận tuỵ, thật thà, bảo vệ người thân. Hợp việc phục vụ.'], ['rộng lượng', 'tốt bụng', 'dễ tin', 'Lợn hiền, hào phóng, thích vui vẻ. Hợp việc chăm sóc, ẩm thực.']],
  en: [['quick', 'resourceful', 'thrifty', 'The Rat is quick, clever and adaptable. Suits work of the mind and networks.'], ['steady', 'honest', 'slow but sure', 'The Buffalo is diligent and keeps its word. Suits patient work.'], ['brave', 'fiery', 'leads', 'The Tiger is strong, bold, sometimes rash. Suits decisive work.'], ['gentle', 'tactful', 'careful', 'The Cat is refined, gracious, self-protective. Suits delicate work.'], ['confident', 'lucky', 'proud', 'The Dragon stands out, full of energy and ambition. Suits big things.'], ['deep', 'mysterious', 'intuitive', 'The Snake is wise, private, thinks it through. Suits work with depth.'], ['free', 'fast', 'enthusiastic', 'The Horse loves freedom, lively, always moving. Suits travel and talk.'], ['gentle', 'creative', 'sensitive', 'The Goat is soft, artistic, needs peace. Suits creative work.'], ['clever', 'fun', 'mischievous', 'The Monkey is sharp, inventive, playful. Suits improvisation.'], ['hard-working', 'direct', 'precise', 'The Rooster is diligent, clear, quick to advise. Suits exact work.'], ['loyal', 'fair', 'cautious', 'The Dog is devoted, honest, protective. Suits service.'], ['generous', 'kind', 'trusting', 'The Pig is gentle, giving, fond of fun. Suits care and food.']],
  de: [['schnell', 'einfallsreich', 'sparsam', 'Die Ratte gilt als schnell, clever und anpassungsfähig. Traditionell passt sie zu Aufgaben, die Köpfchen und gute Kontakte verlangen.'], ['beständig', 'ehrlich', 'langsam, aber sicher', 'Der Büffel gilt als fleißig, verlässlich und ausdauernd. Traditionell passt er zu Arbeit, die Geduld braucht.'], ['mutig', 'feurig', 'führungsstark', 'Der Tiger gilt als kraftvoll, mutig und manchmal impulsiv. Traditionell passt er zu Situationen, in denen Entschlossenheit gefragt ist.'], ['sanft', 'taktvoll', 'vorsichtig', 'Die Katze gilt in der vietnamesischen Tierkreis-Tradition als feinfühlig, höflich und umsichtig. Sie wird mit Geschick und Diplomatie verbunden.'], ['selbstbewusst', 'glücklich', 'stolz', 'Der Drache gilt als auffällig, energiegeladen und ehrgeizig. Traditionell wird er mit großen Vorhaben und sichtbarer Verantwortung verbunden.'], ['tiefgründig', 'geheimnisvoll', 'intuitiv', 'Die Schlange gilt als klug, zurückhaltend und überlegt. Traditionell wird sie mit Tiefe und sorgfältigem Denken verbunden.'], ['freiheitsliebend', 'schnell', 'begeisterungsfähig', 'Das Pferd liebt Bewegung und Freiheit. Traditionell wird es mit Reisen, Kommunikation und einem aktiven Leben verbunden.'], ['sanft', 'kreativ', 'sensibel', 'Die Ziege gilt als feinfühlig, kreativ und friedliebend. Traditionell passt sie zu künstlerischen oder fürsorglichen Tätigkeiten.'], ['clever', 'fröhlich', 'verspielt', 'Der Affe werden Einfallsreichtum, Humor und schnelle Reaktionen zugeschrieben. Sie passt symbolisch zu Aufgaben, die Improvisation verlangen.'], ['fleißig', 'direkt', 'genau', 'Der Hahn gilt als arbeitsam, klar und detailorientiert. Traditionell wird er mit Aufgaben verbunden, bei denen Genauigkeit wichtig ist.'], ['loyal', 'fair', 'vorsichtig', 'Der Hund gilt als treu, ehrlich und beschützend. Traditionell wird er mit Verantwortung und Dienst an anderen verbunden.'], ['großzügig', 'freundlich', 'vertrauensvoll', 'Das Schwein gilt als sanft, großzügig und lebensfroh. Traditionell wird es mit Fürsorge, Genuss und Gastfreundschaft verbunden.']]
};
...
const TEA = [['🐦', 'Chim', 'Bird', 'tin tức đang tới', 'news on the way', 'Vogel', 'Nachrichten sind unterwegs'], ['💗', 'Trái tim', 'Heart', 'tình cảm, một người thương', 'love, someone dear', 'Herz', 'Liebe, ein Herzensmensch'], ['💍', 'Nhẫn', 'Ring', 'cam kết, hôn nhân', 'commitment, marriage', 'Ring', 'Bindung, Versprechen oder Ehe'], ['🔑', 'Chìa khoá', 'Key', 'cửa mở, cơ hội', 'a door opens', 'Schlüssel', 'eine Tür öffnet sich, eine Lösung'], ['➖', 'Đường thẳng', 'Straight line', 'chuyến đi, kế hoạch rõ', 'a journey, a clear plan', 'Gerade Linie', 'Reise oder klarer Plan'], ['🌳', 'Cây', 'Tree', 'thành công dần dần', 'gradual success', 'Baum', 'langsames, stetiges Wachstum'], ['☁️', 'Mây', 'Cloud', 'rối, chưa rõ', 'confusion, not yet clear', 'Wolke', 'Unklarheit, etwas ist noch nicht deutlich'], ['🔤', 'Chữ cái', 'Letter', 'tên một người', 'someone\'s initial', 'Buchstabe', 'ein Name oder Initial'], ['🔢', 'Con số', 'Number', 'ngày hoặc tháng', 'days or months', 'Zahl', 'Tage, Monate oder eine Menge'], ['⭐', 'Ngôi sao', 'Star', 'may mắn, hy vọng', 'luck, hope', 'Stern', 'Hoffnung und günstige Entwicklung'], ['🌙', 'Trăng', 'Moon', 'thay đổi, chuyện tình cảm', 'change, matters of the heart', 'Mond', 'Veränderung und Gefühlsthemen'], ['🐍', 'Rắn', 'Snake', 'thận trọng với một người hoặc tình huống thiếu rõ ràng', 'be cautious with a person or situation that is not fully clear', 'Schlange', 'Vorsicht bei einer Person oder Situation, die nicht ganz klar ist'], ['🐟', 'Cá', 'Fish', 'tin vui, tiền vào', 'good news, money coming', 'Fisch', 'gute Nachricht oder Geldbewegung'], ['🏠', 'Ngôi nhà', 'House', 'an toàn, gia đình', 'safety, home', 'Haus', 'Sicherheit, Zuhause und Familie'], ['⚓', 'Mỏ neo', 'Anchor', 'ổn định, công việc chắc', 'stability, steady work', 'Anker', 'Stabilität und beständige Arbeit'], ['🚪', 'Cánh cửa', 'Door', 'chuyện mới sắp mở', 'something new about to open', 'Tür', 'etwas Neues beginnt sich zu öffnen']];
...
const PC_TRAD = {
  hA: ['Mái nhà, tình yêu mới, niềm vui trong gia đình', 'Home, a new love, happiness in the family', 'Zuhause, neue Liebe, Freude in der Familie'],
  h2: ['Đôi lứa, tình cảm đáp lại, hứa hẹn gắn bó', 'A couple, love returned, a promise to commit', 'Paar, erwiderte Gefühle, Aussicht auf Bindung'],
  h3: ['Cẩn thận trong tình cảm, người thứ ba, lựa chọn của trái tim', 'Care in love, a third person, a choice of the heart', 'Vorsicht in Liebesdingen, Dreieckssituation oder Herzensentscheidung'],
  h4: ['Thay đổi trong nhà, một chuyến đi, hôn nhân bị hoãn', 'A change at home, a journey, a marriage delayed', 'Veränderung zuhause, eine Reise oder verzögerte Bindung'],
  h5: ['Ghen tuông, do dự, một quyết định về tình cảm', 'Jealousy, hesitation, a decision about love', 'Eifersucht, Zögern oder eine Entscheidung in der Liebe'],
  h6: ['Kỷ niệm, người cũ quay lại, lòng rộng lượng', 'Memories, someone from the past returns, generosity', 'Erinnerungen, jemand aus der Vergangenheit, Großzügigkeit'],
  h7: ['Thất vọng, lời hứa không giữ, người hay đổi ý', 'Disappointment, a broken promise, a fickle person', 'Enttäuschung, ein nicht gehaltenes Versprechen oder wechselhafte Haltung'],
  h8: ['Lời mời, cuộc thăm hỏi, quà tặng, tiệc tùng', 'An invitation, a visit, a gift, a celebration', 'Einladung, Besuch, Geschenk oder Feier'],
  h9: ['Lá ước nguyện: điều mong muốn thành hiện thực', 'The wish card: what you hope for comes true', 'Wunschkarte: ein Herzenswunsch kann Erfüllung finden'],
  h10: ['May mắn lớn, gia đình hạnh phúc, thành công', 'Great luck, a happy family, success', 'Großes Glück, harmonisches Familienleben, Erfolg'],
  hJ: ['Một người bạn thân, một người trẻ tốt bụng và chân thành', 'A close friend, a kind and sincere young person', 'Ein enger Freund oder ein freundlicher, aufrichtiger junger Mensch'],
  hQ: ['Một người phụ nữ dịu dàng, yêu thương; người mẹ', 'A gentle, loving woman; the mother', 'Eine sanfte, liebevolle Frau oder eine mütterliche Person'],
  hK: ['Một người đàn ông ấm áp, rộng lượng; lời khuyên tốt', 'A warm, generous man; good advice', 'Ein warmer, großzügiger Mann oder hilfreicher Rat'],
  dA: ['Thư từ, tin nhắn, chiếc nhẫn, tin về tiền bạc', 'A letter, a message, a ring, news about money', 'Brief, Nachricht, Ring oder Neuigkeit über Geld'],
  d2: ['Chuyện tình bị phản đối, bất đồng về tiền, cần chọn một trong hai', 'A romance others disapprove of, a money disagreement, choosing between two', 'Eine Beziehung unter äußerem Druck, Geldstreit oder Wahl zwischen zwei Möglichkeiten'],
  d3: ['Giấy tờ, pháp lý, tranh cãi, cãi vã trong nhà', 'Paperwork, legal matters, quarrels, arguments at home', 'Unterlagen, rechtliche Themen, Streit oder Diskussionen zuhause'],
  d4: ['Thừa kế, tiền bạc ổn định, sự an toàn', 'An inheritance, steady money, security', 'Erbe, beständige Finanzen und Sicherheit'],
  d5: ['Tin vui, thay đổi tốt lên, công việc thuận lợi', 'Good news, a change for the better, business goes well', 'Gute Nachricht, Verbesserung und günstige Geschäftsentwicklung'],
  d6: ['Hôn nhân sớm, cơ hội thứ hai, cẩn thận với chi tiêu', 'An early marriage, a second chance, care with spending', 'Frühe Bindung, zweite Chance und ein Hinweis, Ausgaben im Blick zu behalten'],
  d7: ['Lời đàm tiếu, chỉ trích, lo lắng tiền bạc, mất mát nhỏ', 'Gossip, criticism, money worries, a small loss', 'Gerede, Kritik, Geldsorgen oder ein kleiner Verlust'],
  d8: ['Hôn nhân muộn, chuyến đi ngắn, tiền đến rồi đi', 'A late marriage, a short trip, money that comes and goes', 'Spätere Bindung, kurze Reise oder Geld, das schnell kommt und geht'],
  d9: ['Bất ngờ, phiêu lưu, khoản tiền ngoài dự tính, bồn chồn', 'A surprise, adventure, unexpected money, restlessness', 'Überraschung, Abenteuer, unerwartetes Geld oder Unruhe'],
  d10: ['Tiền bạc, chuyến đi xa, đám cưới, vận may', 'Money, a long journey, a wedding, good fortune', 'Geld, weite Reise, Hochzeit oder günstige Entwicklung'],
  dJ: ['Người đưa tin, một người trẻ mang tin; người giúp nhưng không đáng tin lắm', 'A messenger, a young person bringing news; a helper who is not fully reliable', 'Ein Bote oder junger Mensch mit Nachrichten; Hilfe, auf die man nicht blind vertrauen sollte'],
  dQ: ['Người phụ nữ sành sỏi, hay nói; sự chen ngang', 'A worldly woman, a talker; interference', 'Eine weltgewandte, gesprächige Frau; Einmischung oder Ablenkung'],
  dK: ['Người đàn ông làm ăn, có quyền, cứng đầu', 'A businessman, a man of authority, stubborn', 'Ein Geschäftsmann oder eine Autoritätsperson; durchsetzungsstark und manchmal stur'],
  cA: ['Của cải, thành công, một khởi đầu tốt', 'Wealth, success, a good beginning', 'Wohlstand, Erfolg und ein guter Anfang'],
  c2: ['Đối đầu, lời đồn, thất vọng, tranh cãi', 'Opposition, rumours, disappointment, arguments', 'Widerstand, Gerüchte, Enttäuschung oder Streit'],
  c3: ['Hôn nhân, hợp tác lâu dài, cơ hội thứ hai', 'Marriage, a long partnership, a second chance', 'Ehe, langfristige Zusammenarbeit oder zweite Chance'],
  c4: ['Thay đổi, vận rủi bất ngờ; lời nhắc tránh xung đột', 'A change, a sudden misfortune; a reminder to avoid conflict', 'Veränderung und unerwartete Schwierigkeit; Konflikte möglichst nicht zusätzlich anheizen'],
  c5: ['Bạn mới, một liên minh có ích, hôn nhân', 'New friends, a helpful alliance, marriage', 'Neue Freunde, hilfreiche Allianz oder Bindung'],
  c6: ['Việc làm ăn thuận lợi, được hỗ trợ tài chính', 'Business success, financial support', 'Gute Geschäftsentwicklung oder finanzielle Unterstützung'],
  c7: ['Thịnh vượng, một người bạn tốt; đề phòng người ganh đua', 'Prosperity, a good friend; watch out for a rival', 'Wohlstand und ein guter Freund; zugleich auf Konkurrenz achten'],
  c8: ['Làm việc quá sức, ham may rủi; một lời đề nghị', 'Overwork, a taste for gambling; a proposal', 'Überarbeitung, riskantes Spiel mit dem Glück oder ein Angebot'],
  c9: ['Tình cảm mới; bất đồng với bạn bè', 'A new romance; disagreement with friends', 'Neue Romanze oder Meinungsverschiedenheit mit Freunden'],
  c10: ['Đi xa, thành công trong công việc, may mắn sau nỗ lực', 'Travel, success at work, luck after effort', 'Reise, beruflicher Erfolg und Glück nach eigener Anstrengung'],
  cJ: ['Người bạn đáng tin, chàng trai chân thành', 'A reliable friend, a sincere young man', 'Ein verlässlicher Freund oder aufrichtiger junger Mensch'],
  cQ: ['Người phụ nữ tự tin, ấm áp, hay giúp đỡ', 'A confident, warm, helpful woman', 'Eine selbstbewusste, warme und hilfsbereite Frau'],
  cK: ['Người đàn ông rộng rãi, trung thành; người cố vấn tốt', 'A generous, loyal man; a good adviser', 'Ein großzügiger, loyaler Mann oder guter Berater'],
  sA: ['Kết thúc, quyết định khó, chuyện không may', 'An ending, a hard decision, misfortune', 'Ein Ende, eine schwierige Entscheidung oder eine belastende Wendung'],
  s2: ['Chia ly, tạm dừng, lựa chọn khó, lời nói dối', 'Separation, a pause, a hard choice, a lie', 'Trennung, Pause, schwierige Wahl oder Unwahrheit'],
  s3: ['Đau lòng, phản bội, nước mắt', 'Heartbreak, betrayal, tears', 'Herzschmerz, Verrat oder Tränen'],
  s4: ['Một bước chững lại; hãy nghỉ và hồi sức trước khi đi tiếp.', 'A setback or pause; rest and recover before moving on.', 'Ein Rückschritt oder eine Pause; ruh dich aus und komm wieder zu Kräften, bevor du weitergehst.'],
  s5: ['Trở ngại, lo âu; vượt qua rồi sẽ thành', 'Obstacles, anxiety; success after they pass', 'Hindernisse oder Sorge; Fortschritt wird möglich, wenn sie bearbeitet werden'],
  s6: ['Tiến bộ nhỏ, một chuyến đi để bỏ lại rắc rối', 'Small progress, a journey to leave trouble behind', 'Kleiner Fortschritt oder eine Reise, um Schwierigkeiten hinter sich zu lassen'],
  s7: ['Mất mát, lời cảnh báo; đừng tin người quá dễ', 'A loss, a warning; do not trust too easily', 'Verlust oder Warnung; Vertrauen nicht vorschnell schenken'],
  s8: ['Rắc rối kéo dài, áp lực hoặc chuyện pháp lý cần thận trọng.', 'Ongoing trouble, pressure or a legal matter that calls for care.', 'Anhaltende Schwierigkeiten, Druck oder eine rechtliche Angelegenheit, bei der Vorsicht gefragt ist.'],
  s9: ['Tin xấu, lo lắng, muộn phiền: lá nặng nhất bộ', 'Bad news, worry, sorrow: the heaviest card in the pack', 'Schwere Nachricht, Sorge oder Kummer; traditionell eine der belastendsten Karten des Blatts'],
  s10: ['Lo âu, bị ràng buộc, một giai đoạn khó đang khép lại', 'Anxiety, feeling trapped, a hard period coming to a close', 'Sorge, Gefühl von Enge und eine schwierige Phase, die sich dem Ende nähert'],
  sJ: ['Người trẻ không đáng tin, đối thủ', 'An untrustworthy young person, a rival', 'Ein unzuverlässiger junger Mensch oder Konkurrent'],
  sQ: ['Người phụ nữ sắc sảo, độc lập; lời phê bình gắt.', 'A sharp, independent woman; harsh criticism.', 'Eine scharfsinnige, unabhängige Frau; harte Kritik.'],
  sK: ['Luật sư, thẩm phán hoặc người có quyền; lý trí và nghiêm.', 'A lawyer, judge or person in authority; rational and serious.', 'Ein Anwalt, Richter oder eine Autoritätsperson; rational und ernst.']
};
/* ---- playing cards ---- */
function renderPlayingCards(m, head) {
  ...
  const show = () => {
    ...
    $('#pcout').innerHTML = '<div class="pcrow"><div class="pcard"><span class="' + (suit === 'h' || suit === 'd' ? 'red' : '') + '">' + rank + PC_SUITS.filter((x) => x[0] === suit)[0][1] + '</span></div><div><div class="eyebrow">' + esc(S.pcTrad) + '</div><p class="pctrad">' + esc(lang === 'vi' ? trad[0] : (lang === 'de' ? (trad[2] || trad[1]) : trad[1])) + '</p></div></div>'
...
function renderTea(m, head) {
  ...
  m.innerHTML = head + '<p class="muted">' + esc(S.teaIntro) + '</p><div class="teawrap"><div id="cupwrap"></div><p class="ins" id="teaout"></p></div>'
    + '<h3 style="margin:16px 0 8px">' + esc(S.teaSymbols) + '</h3><div class="teagrid">' + TEA.map((t) => '<div class="tsym"><span class="ic">' + t[0] + '</span><b>' + esc(lang === 'vi' ? t[1] : (lang === 'de' ? t[5] : t[2])) + '</b><span>' + esc(lang === 'vi' ? t[3] : (lang === 'de' ? t[6] : t[4])) + '</span></div>').join('') + '</div>'
  ...
  $('#teadraw').addEventListener('click', () => { const zones = ['rim', 'mid', 'bottom', 'handle']; const t = TEA[Math.floor(Math.random() * TEA.length)], z = zones[Math.floor(Math.random() * zones.length)]; $('#teadrawn').innerHTML = '<div class="tsym big"><span class="ic">' + t[0] + '</span><b>' + esc(lang === 'vi' ? t[1] : (lang === 'de' ? t[5] : t[2])) + '</b><span>' + esc((lang === 'vi' ? t[3] : (lang === 'de' ? t[6] : t[4])) + ' · ' + S.teaZones[z]) + '</span><p class="faint">' + esc(S.teaZoneText[z]) + '</p></div>'; });
}
...
function animalsWheelSVG(active) {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    /* The wheel speaks the reader's language: Tý, Sửu, Dần in Vietnamese; Rat, Buffalo, Tiger in English;
       Ratte, Büffel, Tiger in German. */
    const name = lang === 'vi' ? CHI[i] : ANIMALS[i][lang] || ANIMALS[i].en;
    s += '<button class="aw' + (on ? ' on' : '') + '" data-animal="' + i + '" style="left:' + x.toFixed(1) + '%;top:' + y.toFixed(1) + '%" aria-label="' + esc(name) + '"><span class="e">' + ANIMAL_EMOJI[i] + '</span><b>' + esc(name) + '</b></button>';
  }
  return s + '</div>';
}
function renderAnimals(m, head) {
  ...
  /* The wheel is the Vietnamese one - Mèo, Trâu, Dê - and says so at the top. Below it, what China and
     Korea do differently, in the owner's short sentences. */
  m.innerHTML = head + '<p class="avn"><span class="chip tag">🇻🇳 ' + esc(S.animalVN) + '</span></p><p class="muted">' + esc(S.animalIntro) + '</p><div class="awrapper"><div id="awrap"></div></div><div class="ins" id="aout"></div>'
    + '<div class="card anote"><h3>' + esc(S.animalDiffH) + '</h3><ul>' + S.animalDiff.map((x) => '<li>' + esc(x) + '</li>').join('') + '</ul></div><p class="hint">' + esc(S.animalNote) + '</p>'
