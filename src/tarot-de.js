...
["Der Narr","Anfang · Vertrauen · Unschuld · der Sprung",
 ...
 "Der Anfang von etwas, bevor du irgendeinen Beweis hast, dass es gelingt. Vertrauen, das dem Beweis vorausläuft, und die besondere Freiheit, noch nichts verlieren zu können.",
...
["Der Magier","Wille · Konzentration · Mittel · Verwirklichung",
 ...
 "Du hast bereits jedes Werkzeug, das die Lage verlangt. Die Arbeit besteht nicht darin, mehr zu bekommen, sondern das Vorhandene auf eine Sache zu richten.",
...
["Die Hohepriesterin","Intuition · das Unenthüllte · inneres Wissen",
 ...
 "Die Antwort ist da, aber sie ist noch nicht aufgetaucht. Warte, hör nach innen und erzwing nichts — weder bei dir noch bei anderen.",
...
["Das Rad des Schicksals","Zyklen · Wendepunkt · Glück",
 ...
 "Die Umstände wechseln nach ihrem eigenen Fahrplan. Geh mit der Drehung, statt dich an eine Speiche zu klammern und zu verlangen, dass sie oben bleibt.",
...
wands:{
 ...
 ["Eine Gestalt kämpft sich vorwärts, tief gebeugt unter einem Bündel von zehn Stäben.","Überladung. Du hast alles auf dich genommen, und so ist es wirklich zu viel zu tragen.","Etwas ablegen. Endlich abgeben, oder das Nächste ausschlagen."]],
 court:[
...
cups:{
 ...
 pips:[
 ["Eine Hand reicht einen überfließenden Kelch, in den eine Taube herabsteigt, fünf Ströme laufen über.","Ein Öffnen des Gefühls — angebotene Liebe, eine beginnende Verbindung, ein Gefühl, das noch unverdorben ist.","Verschlossen, oder ein Gefühl, das entschlossen wieder hinuntergedrückt wird."],
 ...
 ["Eine Gestalt sitzt mit verschränkten Armen unter einem Baum und beachtet einen Kelch nicht, der ihr aus einer Wolke gereicht wird.","Unzufriedenheit und Langeweile. Dir wird etwas angeboten, und du bringst es nicht fertig, es zu wollen.","Aufwachen für das Angebot. Die Teilnahmslosigkeit lässt nach."],
 ...
 ["Sieben Kelche schweben in Wolken und enthalten eine Burg, Juwelen, einen Kranz, eine Schlange und eine verhüllte Gestalt.","Zu viele Möglichkeiten, die meisten davon Wunschbilder. Wähl eine und mach sie wirklich, sonst wird keine davon wirklich.","Klarheit kommt an, oder das Wunschdenken zeigt sich als das, was es war."],
 ["Eine Gestalt geht unter einem verfinsterten Mond von acht gestapelten Kelchen fort, den Bergen entgegen.","Etwas verlassen, das in Ordnung ist, aber nicht genug. Ein Aufbruch, bewusst gewählt und persönlich teuer.","Zurückgehen, oder es nicht über sich bringen zu gehen."],
...
swords:{
 ...
 ["Ein Fährmann stakt ein Boot mit einem verhüllten Fahrgast und sechs Schwertern zu einem ruhigeren Ufer.","Eine schwere Überfahrt fort vom Ärger. Von hier wird es stiller, aber du musstest gehen, um das zu bekommen.","Gepäck, das mitkommt; ein Ortswechsel, der nichts löst, weil das Problem mitgereist ist."],
 ["Ein Mann schleicht mit fünf Schwertern aus einem Lager und lässt zwei im Boden stecken.","Strategie und Ausweichen. Mit etwas davonkommen — und die zwei Schwerter, die du nicht tragen konntest.","Auffliegen, oder sich entscheiden, reinen Tisch zu machen."],
 ...
 ["Eine Gestalt sitzt im Bett und hält das Gesicht in den Händen; neun Schwerter hängen an der Wand dahinter.","Angst um drei Uhr morgens. Das Grauen ist echt; sein Ausmaß ist es nicht.","Das Schlimmste geht vorbei, oder du sagst es endlich jemandem."],
 ...
 ["Ein Ritter prescht kopfüber durch einen Sturm, das Schwert erhoben, das Pferd in vollem Lauf.","Schnell, direkt und streitlustig. Geht geradewegs auf den Punkt zu und bremst für Gefühle nicht ab.","Angriffslust, Taktlosigkeit, oder ein Sturmlauf auf den völlig falschen Hügel."],
 ["Eine strenge Königin sitzt über den Wolken, das Schwert aufrecht, eine Hand ausgestreckt.","Klarheit ohne Sentimentalität. Ehrlichkeit, freundlich gesagt, aber nie abgemildert. Sie hat etwas hinter sich.","Kälte, Bitterkeit, oder Kritik, die zur Persönlichkeit geworden ist."],
...
pentacles:{
 ...
 pips:[
 ["Eine Hand reicht eine goldene Münze über einem ummauerten Garten, dessen Tor sich zu den Bergen öffnet.","Eine greifbare Gelegenheit — ein Angebot, eine Arbeit, ein Samen von Wohlstand, den es wirklich gibt.","Eine verpasste Chance, oder ein Plan ohne Fundament darunter."],
