...
const COURSES = [
  ...
  { id: 'manifest', price: 75000, months: 12, name: { vi: 'Bộ Manifestation', en: 'Manifestation set' },
    blurb: { vi: 'Tám phương pháp có công cụ làm ngay trong app: viết kịch bản, WOOP, bảng tầm nhìn có ảnh, nghi thức trăng, kế hoạch nếu-thì, buông bỏ, giới hạn, nến và đá. Mọi thứ bạn viết được lưu trên máy và có thể xoá làm lại bất cứ lúc nào.', en: 'Eight methods with tools you use right in the app: scripting, WOOP, a vision board with photos, Moon rituals, if-then plans, letting go, limits, candles and stones. Everything you write is saved on your device and can be cleared and redone any time.' },
    includes: { vi: ['8 bài hướng dẫn nâng cao', 'Công cụ viết, bảng ảnh, kế hoạch, nghi thức', 'Nến và đá theo mục đích', 'Dùng 12 tháng, xem offline'], en: ['8 advanced guides', 'Writing, photo board, plans and ritual tools', 'Candles and stones by purpose', '12 months of access, works offline'] } }
];
