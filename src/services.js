...
const COURSES = [
  ...
  { id: 'playing', price: 150000, months: 6, name: { vi: 'Khóa Bài Tây', en: 'Cartomancy course (playing cards)' },
  ...
  { id: 'luck', price: 50000, months: 12, name: { vi: 'Đồng xu và cây thông điệp', en: 'Coin and message tree' },
  ...
  { id: 'coin', price: 30000, months: 12, name: { vi: 'Tung đồng xu không giới hạn', en: 'Unlimited coin flips' },
  ...
  { id: 'tree', price: 30000, months: 12, name: { vi: 'Rung cây không giới hạn', en: 'Unlimited tree shakes' },
