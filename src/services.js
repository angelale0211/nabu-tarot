...
const SERVICES = [
  { id: 'tarot', icon: PICK_ICON, tone: 'blue', name: { vi: 'Tarot', en: 'Tarot', de: 'Tarot' },
    ...
    packages: [
      { id: 'q1', name: { vi: '1 câu hỏi', en: '1 question', de: '1 Frage' }, price: 39000, abroad: { en: 5, de: 5 } },
      { id: 'q3', name: { vi: '3 câu hỏi', en: '3 questions', de: '3 Fragen' }, price: 99000, abroad: { en: 12, de: 11 } },
      { id: 'deep', name: { vi: 'Chuyên sâu 1 vấn đề', en: 'One matter in depth', de: 'Ein Thema ausführlich' }, price: 149000, abroad: { en: 18, de: 16 },
      ...
      { id: 'm3', name: { vi: 'Tổng quan 3 tháng', en: '3-month overview', de: 'Überblick 3 Monate' }, price: 159000, abroad: { en: 19, de: 17 },
      ...
      { id: 'm6', name: { vi: 'Tổng quan 6 tháng', en: '6-month overview', de: 'Überblick 6 Monate' }, price: 249000, abroad: { en: 29, de: 27 },
      ...
      { id: 'm12', name: { vi: 'Tổng quan 12 tháng', en: '12-month overview', de: 'Überblick 12 Monate' }, price: 399000, abroad: { en: 45, de: 41 },
  ...
  { id: 'tarot-oracle', icon: '🌙', tone: 'pink', name: { vi: 'Tarot + Oracle', en: 'Tarot + Oracle', de: 'Tarot + Oracle' },
    ...
    packages: [
      { id: 'deep', name: { vi: 'Chuyên sâu 1 vấn đề', en: 'One matter in depth', de: 'Ein Thema ausführlich' }, price: 179000, abroad: { en: 21, de: 19 },
      ...
      { id: 'm3', name: { vi: 'Tổng quan 3 tháng', en: '3-month overview', de: 'Überblick 3 Monate' }, price: 199000, abroad: { en: 24, de: 22 },
      ...
      { id: 'm6', name: { vi: 'Tổng quan 6 tháng', en: '6-month overview', de: 'Überblick 6 Monate' }, price: 299000, abroad: { en: 35, de: 32 },
      ...
      { id: 'm12', name: { vi: 'Tổng quan 12 tháng', en: '12-month overview', de: 'Überblick 12 Monate' }, price: 459000, abroad: { en: 52, de: 48 },
  ...
  { id: 'tea', icon: '🍵', tone: 'gold', name: { vi: 'Bài trà', en: 'Tealeaf fortune telling', de: 'Teeblattdeutung' },
    ...
    packages: [
      { id: 'coming', name: { vi: 'Điều gì đang đến với bạn?', en: 'What is coming your way?', de: 'Was auf dich zukommt' }, price: 99000, abroad: { en: 12, de: 11 },
      ...
      { id: 'm1', name: { vi: '1 tháng', en: '1 month', de: '1 Monat' }, price: 79000, abroad: { en: 9, de: 8 },
      ...
      { id: 'm3', name: { vi: '3 tháng', en: '3 months', de: '3 Monate' }, price: 159000, abroad: { en: 19, de: 17 },
      ...
      { id: 'm6', name: { vi: '6 tháng', en: '6 months', de: '6 Monate' }, price: 279000, abroad: { en: 33, de: 30 },
      ...
      { id: 'm12', name: { vi: '12 tháng', en: '12 months', de: '12 Monate' }, price: 499000, abroad: { en: 57, de: 52 },
      ...
      { id: 'area', name: { vi: 'Một lĩnh vực chuyên sâu', en: 'One area in depth', de: 'Ein Bereich ausführlich' }, price: 149000, abroad: { en: 18, de: 16 },
  ...
  { id: 'tea-oracle', icon: '✨', tone: 'lav', name: { vi: 'Bài trà + Oracle', en: 'Tealeaf + Oracle', de: 'Teeblattdeutung + Oracle' },
    ...
    packages: [
      { id: 'coming', name: { vi: 'Điều sắp tới', en: 'What is coming your way', de: 'Was auf dich zukommt' }, price: 129000, abroad: { en: 15, de: 14 },
      ...
      { id: 'm1', name: { vi: '1 tháng', en: '1 month', de: '1 Monat' }, price: 109000, abroad: { en: 13, de: 12 },
      ...
      { id: 'm3', name: { vi: '3 tháng', en: '3 months', de: '3 Monate' }, price: 199000, abroad: { en: 24, de: 22 },
      ...
      { id: 'm6', name: { vi: '6 tháng', en: '6 months', de: '6 Monate' }, price: 329000, abroad: { en: 38, de: 35 },
      ...
      { id: 'm12', name: { vi: '12 tháng', en: '12 months', de: '12 Monate' }, price: 569000, abroad: { en: 65, de: 59 },
  ...
  { id: 'tuvi', icon: '🌸', tone: 'pink', name: { vi: 'Tử vi', en: 'Tử vi (Vietnamese astrology)', de: 'Tử vi (vietnamesische Astrologie)' },
    ...
    needsBirth: true,
    packages: [
      { id: 'one', name: { vi: '1 vấn đề', en: '1 matter', de: '1 Thema' }, price: 99000, abroad: { en: 20, de: 18 } },
      { id: 'year', name: { vi: 'Vận hạn năm', en: 'The year ahead', de: 'Das kommende Jahr' }, price: 333000, abroad: { en: 45, de: 41 } },
      { id: 'all', name: { vi: 'Tổng quan mọi vấn đề', en: 'Full overview of everything', de: 'Gesamtüberblick' }, price: 666000, abroad: { en: 85, de: 78 } }
    ] },
  { id: 'talk', icon: '💬', tone: 'blue', name: { vi: 'Tâm sự', en: 'Just talk', de: 'Einfach reden' },
    ...
    packages: [
      { id: 't30', name: { vi: '30 phút', en: '30 minutes', de: '30 Minuten' }, price: 59000, abroad: { en: 9, de: 8 } },
      { id: 't60', name: { vi: '60 phút', en: '60 minutes', de: '60 Minuten' }, price: 99000, abroad: { en: 15, de: 14 } }
    ] }
];
